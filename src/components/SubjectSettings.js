...
function SubjectSettings({ data, updateData, nextStep, prevStep }) {
  ...
  const defaultSubjects = [
    // 기본 과목들 (constraints_export_2025-07-22.json 기반)
    { name: '국어', weekly_hours: 5, is_merged: false, is_space_limited: false, max_classes_at_once: 1, requires_co_teaching: false },
    { name: '도덕', weekly_hours: 2, is_merged: false, is_space_limited: false, max_classes_at_once: 1, requires_co_teaching: false },
    { name: '역사', weekly_hours: 3, is_merged: false, is_space_limited: false, max_classes_at_once: 1, requires_co_teaching: false },
    { name: '사회', weekly_hours: 3, is_merged: false, is_space_limited: false, max_classes_at_once: 1, requires_co_teaching: false },
    { name: '수학', weekly_hours: 5, is_merged: false, is_space_limited: false, max_classes_at_once: 1, requires_co_teaching: false },
    { name: '과학', weekly_hours: 4, is_merged: false, is_space_limited: false, max_classes_at_once: 1, requires_co_teaching: false },
    { name: '기술가정', weekly_hours: 2, is_merged: false, is_space_limited: false, max_classes_at_once: 1, requires_co_teaching: false },
    { name: '정보', weekly_hours: 1, is_merged: false, is_space_limited: false, max_classes_at_once: 1, requires_co_teaching: false },
    { name: '체육', weekly_hours: 3, is_merged: false, is_space_limited: true, max_classes_at_once: 2, requires_co_teaching: false },
    { name: '음악', weekly_hours: 2, is_merged: false, is_space_limited: false, max_classes_at_once: 1, requires_co_teaching: false },
    { name: '미술', weekly_hours: 2, is_merged: false, is_space_limited: false, max_classes_at_once: 1, requires_co_teaching: false },
    { name: '영어', weekly_hours: 4, is_merged: false, is_space_limited: false, max_classes_at_once: 1, requires_co_teaching: false },
    { name: '원어민', weekly_hours: 1, is_merged: false, is_space_limited: false, max_classes_at_once: 1, requires_co_teaching: false },
    { name: '보건', weekly_hours: 1, is_merged: false, is_space_limited: false, max_classes_at_once: 1, requires_co_teaching: false },
    { name: '진로와직업', weekly_hours: 1, is_merged: false, is_space_limited: false, max_classes_at_once: 1, requires_co_teaching: false },
    
    // 특별 활동 과목들 (dongari_sports_fixed_classes.json 기반)
    { name: '동아리', weekly_hours: 1, is_merged: false, is_space_limited: false, max_classes_at_once: 1, requires_co_teaching: false },
    { name: '스포츠', weekly_hours: 1, is_merged: false, is_space_limited: false, max_classes_at_once: 1, requires_co_teaching: false }
  ];
                  ...
                  <div key={index} className="flex items-center justify-between p-5 bg-gray-50 rounded-xl border border-gray-200 hover:shadow-md hover:bg-white transition-all">
                    <div className="flex-1 flex items-center gap-6">
                      <input
                        ...
                        className="font-semibold text-xl bg-transparent border-none focus:outline-none min-w-[140px]"
                        title={subject.name}
                      />
                      ...
                      <div className="flex items-center gap-6">
                        <label className="flex items-center gap-3 text-base cursor-pointer">
                          <input
                            ...
                            onChange={(e) => updateSubject(index, 'is_merged', e.target.checked)}
                            className="w-5 h-5"
                          />
                        ...
                        <label className="flex items-center gap-3 text-base cursor-pointer">
                          <input
                            ...
                            onChange={(e) => updateSubject(index, 'is_space_limited', e.target.checked)}
                            className="w-5 h-5"
                          />
                        ...
                        <label className="flex items-center gap-3 text-base cursor-pointer">
                          <input
                            ...
                            onChange={(e) => updateSubject(index, 'requires_co_teaching', e.target.checked)}
                            className="w-5 h-5"
                          />
                        ...
                        {subject.is_space_limited && (
                          <div className="flex items-center gap-3">
                            <span className="text-base text-gray-600">최대</span>
                            <input
                              type="number"
                              min="1"
                              max={getTotalClassesFromBase()}
                              value={subject.max_classes_at_once}
                              onChange={(e) => updateSubject(index, 'max_classes_at_once', parseInt(e.target.value) || 1)}
                              className="w-20 px-3 py-2 border border-gray-300 rounded-lg text-center text-base focus:outline-none focus:border-blue-500"
                            />
                            <span className="text-base text-gray-600">반</span>
                          </div>
                        )}
                      </div>
                    </div>
                    ...
                    <button 
                      className="ml-6 bg-red-500 text-white px-4 py-3 rounded-lg text-base font-semibold hover:bg-red-600 hover:shadow-lg transition-all"
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-lg text-gray-700">총 과목:</span>
              ...
              <div>
                ...
                <ul className="space-y-3 text-base text-gray-700">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span><strong>동시반수:</strong> 특별실 수용 가능 반 수</span>
                  </li>
                </ul>
              </div>
